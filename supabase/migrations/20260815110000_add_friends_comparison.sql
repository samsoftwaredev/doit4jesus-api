-- A single comparison payload prevents clients from stitching together
-- leaderboard, friend-card, badge, and streak requests with inconsistent
-- snapshots or duplicated authorization checks.
