...
export async function GET(request: Request) {
  try {
    ...
    const query = prayerMapQuerySchema.parse(Object.fromEntries(url.searchParams.entries()))
    ...
    if (query.countryCode) dbQuery = dbQuery.eq('country_code', query.countryCode)
